...
ifneq "$(CC_VERSION_TEXT)" "Android (6877366 based on r383902b1) clang version 11.0.2 (https://android.googlesource.com/toolchain/llvm-project b397f81060ce6d701042b782172ed13bee898b79)"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-android- --gcc-toolchain=/usr -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
